...
capture = cv2.VideoCapture('C:/Users/ASUS/OneDrive/Escritorio/EPN/5toSemestre/InteligenciaArtificial/Proyecto IA - Asistente Virtual/Videos/Alexander.mp4')  # 0 tu propia camara, #1 camara remota, path.mp4
...
face_classif = cv2.CascadeClassifier('C:/Users/ASUS/OneDrive/Escritorio/EPN/5toSemestre/InteligenciaArtificial/opencv-master/data/haarcascades/haarcascade_frontalface_default.xml')
count = 0
